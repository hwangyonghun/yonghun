...
def generate_self_signed_cert():
    ...
    subject = issuer = x509.Name([
        ...
        x509.NameAttribute(NameOID.ORGANIZATION_NAME, u"Veritas Guard AI"),
        x509.NameAttribute(NameOID.COMMON_NAME, u"www.aisolute.com"),
    ])
    ...
    cert = x509.CertificateBuilder().subject_name(
        ...
        x509.SubjectAlternativeName([x509.DNSName(u"www.aisolute.com"), x509.DNSName(u"localhost")]),
        critical=False,
